...
--------------------------------------------------------------------------------------|
    ...
    Output_logic: process(current_state)
        begin
            ...
            case (current_state) is
                when fetch_0 =>
                    Bus1_Sel <= "00";           --PC, Bus1 e verildi
                    Bus2_Sel <= "01";           --Bus1, Bus2 ye baglandi
                    MAR_Load <= '1';            --Adres MAR a yazýldi
                when fetch_1 =>
                    PC_Inc <= '1';              --Sonraki komuta gecildi
                when fetch_2 =>
                    Bus2_Sel <= "10";           --Bellekten veri alindi
                    IR_Load <= '1';             --IR dan ne oldugu cozuldu
                when decode_3 =>
                ------------------
